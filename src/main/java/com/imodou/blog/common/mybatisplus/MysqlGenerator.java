package com.imodou.blog.common.mybatisplus;
...
import com.imodou.blog.common.mybatisplus.GeneratorTest;
...
public class MysqlGenerator extends GeneratorTest {
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                // 全局配置
                new GlobalConfig()
                        .setOutputDir("D:\\workspace\\blog\\src\\main\\java")//输出目录
                ...
                new StrategyConfig()
                        ...
                        .setInclude(new String[]{"t_article","t_article_category","t_article_label","t_category","t_comment","t_label","t_user"})
