package com.imodou.blog.common.constant;
...
public class Message {
    ...
    public static final String CATEGORY_UPDATE_SUCCESS="成功修改分类信息";
    public static final String CATEGORY_UPDATE_FAIL="修改分类信息失败";
